  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <button className='flex items-center gap-2 px-3 py-2 text-sm bg-violet-200 text-violet-800 rounded hover:bg-violet-300 transition-colors disabled:opacity-50'>
