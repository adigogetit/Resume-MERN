...
const hero = () => {
    ...
    return ( 
        <>
            <section className='bg-gray-100  bg-[url("https://assets.prebuiltui.com/images/components/hero-section/hero-net-image.png")] bg-no-repeat bg-bottom bg-size-[100%_auto] px-4 pt-5 md:pb-32'>

                <nav className="flex items-center justify-between px-2.5 md:pl-6 py-2 max-w-6xl rounded-full mx-auto w-full border border-gray-300 bg-white/80 backdrop-blur">
                    ...
                    <nav className={`max-md:fixed max-md:top-0 max-md:left-0 max-md:overflow-hidden items-center justify-center max-md:h-screen ${isMenuOpen ? 'max-md:w-full bg-white/90 backdrop-blur-md z-50' : 'max-md:w-0'} transition-[width] flex-col md:flex-row flex gap-12 text-gray-800 text-m font-normal`}>
                        ...
                        <button onClick={toggleMenu} className="md:hidden text-gray-700 bg-gray-200 p-1.5 rounded-md">
                ...
                <p className="text-base mx-auto text-gray-600 text-center mt-4">
