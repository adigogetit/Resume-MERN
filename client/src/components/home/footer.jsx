...
const Footer = () => {
  return (
    <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[14px] text-gray-500 bg-black">
      ...
      <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
        ...
        <p className="mt-3 text-center">© 2026 <a href="/">PrebuiltUI</a></p>
      </div>
    </footer>
  )
}
